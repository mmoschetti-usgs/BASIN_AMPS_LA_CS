%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%
% Name: Plot_GMM_v_Distance_Comparisons_B_1080.m
%
...
%% Import Data from Excel Spreadsheets
    ...
    addpath('/Users/ashumway/Documents/Projects/2014_Additional_Periods_and_Site_Classes/GMM_QA_2014_NSHM_nshmp-haz/NGAW2/nshmp-haz/')
    
    nshmp_haz_data_ASK_14 = csvread('ASK_14_Median_GMMs_SS_1080.csv');
    R = nshmp_haz_data_ASK_14(1:19,1);
    nshmp_haz_data_BSSA_14 = csvread('BSSA_14_Median_GMMs_SS_1080.csv');
    nshmp_haz_data_CB_14 = csvread('CB_14_Median_GMMs_SS_1080.csv');
    nshmp_haz_data_CY_14 = csvread('CY_14_Median_GMMs_SS_1080.csv');
    nshmp_haz_data_IDRISS_14 = csvread('IDRISS_14_Median_GMMs_SS_1080.csv');
...
% PGA
    ...
    h = legend('ASK14','BSSA14','CB14','CY14','I14');
    ...
    title1 = 'NGA-W2 Median GMM Comparison - M5 - Vs30 = 1080 m/s';
    text(10,20,title1,'FontWeight','bold'); % Position of Title [x-axis, y-axis]
    saveas(gcf,'NGAW2_PGA_1080_GM_vs_Distance_Plot_M5','png')
...
% 0.1 Sec (10 Hz)
    ...
    title1 = 'NGA-W2 Median GMM Comparison - M5 - Vs30 = 1080 m/s';
    text(10,20,title1,'FontWeight','bold'); % Position of Title [x-axis, y-axis]
    saveas(gcf,'NGAW2_SA0P1_1080_GM_vs_Distance_Plot_M5','png')    
...
% 0.2 Sec (5 Hz)
    ...
    title1 = 'NGA-W2 Median GMM Comparison - M5 - Vs30 = 1080 m/s';
    text(10,20,title1,'FontWeight','bold'); % Position of Title [x-axis, y-axis]
    saveas(gcf,'NGAW2_SA0P2_1080_GM_vs_Distance_Plot_M5','png')      
...
% 0.3 Sec (3.33 Hz)
    ...
    title1 = 'NGA-W2 Median GMM Comparison - M5 - Vs30 = 1080 m/s';
    text(10,20,title1,'FontWeight','bold'); % Position of Title [x-axis, y-axis]
    saveas(gcf,'NGAW2_SA0P3_1080_GM_vs_Distance_Plot_M5','png')          
...
% 0.5 Sec (2 Hz)
    ...
    title1 = 'NGA-W2 Median GMM Comparison - M5 - Vs30 = 1080 m/s';
    text(10,20,title1,'FontWeight','bold'); % Position of Title [x-axis, y-axis]
    saveas(gcf,'NGAW2_SA0P5_1080_GM_vs_Distance_Plot_M5','png')     
...
% 0.75 Sec (1.33 Hz)
    ...
    title1 = 'NGA-W2 Median GMM Comparison - M5 - Vs30 = 1080 m/s';
    text(10,20,title1,'FontWeight','bold'); % Position of Title [x-axis, y-axis]
    saveas(gcf,'NGAW2_SA0P75_1080_GM_vs_Distance_Plot_M5','png')       
...
% 1 Sec (1 Hz)
    ...
    title1 = 'NGA-W2 Median GMM Comparison - M5 - Vs30 = 1080 m/s';
    text(10,20,title1,'FontWeight','bold'); % Position of Title [x-axis, y-axis]
    saveas(gcf,'NGAW2_SA1P0_1080_GM_vs_Distance_Plot_M5','png')      
...
% 2 Sec (0.5 Hz)
    ...
    title1 = 'NGA-W2 Median GMM Comparison - M5 - Vs30 = 1080 m/s';
    text(10,20,title1,'FontWeight','bold'); % Position of Title [x-axis, y-axis]
    saveas(gcf,'NGAW2_SA2P0_1080_GM_vs_Distance_Plot_M5','png')     
...
% 3 Sec (0.33 Hz)
    ...
    title1 = 'NGA-W2 Median GMM Comparison - M5 - Vs30 = 1080 m/s';
    text(10,20,title1,'FontWeight','bold'); % Position of Title [x-axis, y-axis]
    saveas(gcf,'NGAW2_SA3P0_1080_GM_vs_Distance_Plot_M5','png')     
...
% 4 Sec (0.25 Hz)
    ...
    title1 = 'NGA-W2 Median GMM Comparison - M5 - Vs30 = 1080 m/s';
    text(10,20,title1,'FontWeight','bold'); % Position of Title [x-axis, y-axis]
    saveas(gcf,'NGAW2_SA4P0_1080_GM_vs_Distance_Plot_M5','png')    
    
% 5 Sec (0.2 Hz)

    figure('visible','off')
    % GM vs. Distance Plots
    loglog(R, nshmp_haz_data_ASK_14(1:19,52), 'b-','LineWidth',2);
    hold on
    grid on 
    loglog(R, nshmp_haz_data_BSSA_14(1:19,52), 'r-','LineWidth',2);
    loglog(R, nshmp_haz_data_CB_14(1:19,52), 'g-','LineWidth',2);
    loglog(R, nshmp_haz_data_CY_14(1:19,52), 'c-','LineWidth',2);
    loglog(R, nshmp_haz_data_IDRISS_14(1:19,52), 'k-','LineWidth',2);
    ...
    title1 = 'NGA-W2 Median GMM Comparison - M5 - Vs30 = 1080 m/s';
    text(10,20,title1,'FontWeight','bold'); % Position of Title [x-axis, y-axis]
    saveas(gcf,'NGAW2_SA5P0_1080_GM_vs_Distance_Plot_M5','png')   
...
% PGA
    ...
    set(h,'Interpreter','none');
    set(h,'Position',[40 10]); % Position of subtilte, [center value, y-axis]
    title1 = 'NGA-W2 Median GMM Comparison - M6 - Vs30 = 1080 m/s';
    text(10,20,title1,'FontWeight','bold'); % Position of Title [x-axis, y-axis]
    saveas(gcf,'NGAW2_PGA_1080_GM_vs_Distance_Plot_M6','png')
...
% 0.1 Sec (10 Hz)
    ...
    title1 = 'NGA-W2 Median GMM Comparison - M6 - Vs30 = 1080 m/s';
    text(10,20,title1,'FontWeight','bold'); % Position of Title [x-axis, y-axis]
    saveas(gcf,'NGAW2_SA0P1_1080_GM_vs_Distance_Plot_M6','png')    
...
% 0.2 Sec (5 Hz)
    ...
    title1 = 'NGA-W2 Median GMM Comparison - M6 - Vs30 = 1080 m/s';
    text(10,20,title1,'FontWeight','bold'); % Position of Title [x-axis, y-axis]
    saveas(gcf,'NGAW2_SA0P2_1080_GM_vs_Distance_Plot_M6','png')      
...
% 0.3 Sec (3.33 Hz)
    ...
    title1 = 'NGA-W2 Median GMM Comparison - M6 - Vs30 = 1080 m/s';
    text(10,20,title1,'FontWeight','bold'); % Position of Title [x-axis, y-axis]
    saveas(gcf,'NGAW2_SA0P3_1080_GM_vs_Distance_Plot_M6','png')          
...
% 0.5 Sec (2 Hz)
    ...
    title1 = 'NGA-W2 Median GMM Comparison - M6 - Vs30 = 1080 m/s';
    text(10,20,title1,'FontWeight','bold'); % Position of Title [x-axis, y-axis]
    saveas(gcf,'NGAW2_SA0P5_1080_GM_vs_Distance_Plot_M6','png')     
...
% 0.75 Sec (1.33 Hz)
    ...
    title1 = 'NGA-W2 Median GMM Comparison - M6 - Vs30 = 1080 m/s';
    text(10,20,title1,'FontWeight','bold'); % Position of Title [x-axis, y-axis]
    saveas(gcf,'NGAW2_SA0P75_1080_GM_vs_Distance_Plot_M6','png')       
...
% 1 Sec (1 Hz)
    ...
    title1 = 'NGA-W2 Median GMM Comparison - M6 - Vs30 = 1080 m/s';
    text(10,20,title1,'FontWeight','bold'); % Position of Title [x-axis, y-axis]
    saveas(gcf,'NGAW2_SA1P0_1080_GM_vs_Distance_Plot_M6','png')      
...
% 2 Sec (0.5 Hz)
    ...
    title1 = 'NGA-W2 Median GMM Comparison - M6 - Vs30 = 1080 m/s';
    text(10,20,title1,'FontWeight','bold'); % Position of Title [x-axis, y-axis]
    saveas(gcf,'NGAW2_SA2P0_1080_GM_vs_Distance_Plot_M6','png')     
...
% 3 Sec (0.33 Hz)
    ...
    title1 = 'NGA-W2 Median GMM Comparison - M6 - Vs30 = 1080 m/s';
    text(10,20,title1,'FontWeight','bold'); % Position of Title [x-axis, y-axis]
    saveas(gcf,'NGAW2_SA3P0_1080_GM_vs_Distance_Plot_M6','png')     
...
% 4 Sec (0.25 Hz)
    ...
    title1 = 'NGA-W2 Median GMM Comparison - M6 - Vs30 = 1080 m/s';
    text(10,20,title1,'FontWeight','bold'); % Position of Title [x-axis, y-axis]
    saveas(gcf,'NGAW2_SA4P0_1080_GM_vs_Distance_Plot_M6','png')    
...
% 5 Sec (0.2 Hz)
    ...
    title1 = 'NGA-W2 Median GMM Comparison - M6 - Vs30 = 1080 m/s';
    text(10,20,title1,'FontWeight','bold'); % Position of Title [x-axis, y-axis]
    saveas(gcf,'NGAW2_SA5P0_1080_GM_vs_Distance_Plot_M6','png') 
...
% PGA
    ...
    set(h,'Interpreter','none');
    set(h,'Position',[40 10]); % Position of subtilte, [center value, y-axis]
    title1 = 'NGA-W2 Median GMM Comparison - M7 - Vs30 = 1080 m/s';
    text(10,20,title1,'FontWeight','bold'); % Position of Title [x-axis, y-axis]
    saveas(gcf,'NGAW2_PGA_1080_GM_vs_Distance_Plot_M7','png')
...
% 0.1 Sec (10 Hz)
    ...
    title1 = 'NGA-W2 Median GMM Comparison - M7 - Vs30 = 1080 m/s';
    text(10,20,title1,'FontWeight','bold'); % Position of Title [x-axis, y-axis]
    saveas(gcf,'NGAW2_SA0P1_1080_GM_vs_Distance_Plot_M7','png')    
...
% 0.2 Sec (5 Hz)
    ...
    title1 = 'NGA-W2 Median GMM Comparison - M7 - Vs30 = 1080 m/s';
    text(10,20,title1,'FontWeight','bold'); % Position of Title [x-axis, y-axis]
    saveas(gcf,'NGAW2_SA0P2_1080_GM_vs_Distance_Plot_M7','png')      
...
% 0.3 Sec (3.33 Hz)
    ...
    title1 = 'NGA-W2 Median GMM Comparison - M7 - Vs30 = 1080 m/s';
    text(10,20,title1,'FontWeight','bold'); % Position of Title [x-axis, y-axis]
    saveas(gcf,'NGAW2_SA0P3_1080_GM_vs_Distance_Plot_M7','png')          
...
% 0.5 Sec (2 Hz)
    ...
    title1 = 'NGA-W2 Median GMM Comparison - M7 - Vs30 = 1080 m/s';
    text(10,20,title1,'FontWeight','bold'); % Position of Title [x-axis, y-axis]
    saveas(gcf,'NGAW2_SA0P5_1080_GM_vs_Distance_Plot_M7','png')     
...
% 0.75 Sec (1.33 Hz)
    ...
    title1 = 'NGA-W2 Median GMM Comparison - M7 - Vs30 = 1080 m/s';
    text(10,20,title1,'FontWeight','bold'); % Position of Title [x-axis, y-axis]
    saveas(gcf,'NGAW2_SA0P75_1080_GM_vs_Distance_Plot_M7','png')       
...
% 1 Sec (1 Hz)
    ...
    title1 = 'NGA-W2 Median GMM Comparison - M7 - Vs30 = 1080 m/s';
    text(10,20,title1,'FontWeight','bold'); % Position of Title [x-axis, y-axis]
    saveas(gcf,'NGAW2_SA1P0_1080_GM_vs_Distance_Plot_M7','png')      
...
% 2 Sec (0.5 Hz)
    ...
    title1 = 'NGA-W2 Median GMM Comparison - M7 - Vs30 = 1080 m/s';
    text(10,20,title1,'FontWeight','bold'); % Position of Title [x-axis, y-axis]
    saveas(gcf,'NGAW2_SA2P0_1080_GM_vs_Distance_Plot_M7','png')     
...
% 3 Sec (0.33 Hz)
    ...
    title1 = 'NGA-W2 Median GMM Comparison - M7 - Vs30 = 1080 m/s';
    text(10,20,title1,'FontWeight','bold'); % Position of Title [x-axis, y-axis]
    saveas(gcf,'NGAW2_SA3P0_1080_GM_vs_Distance_Plot_M7','png')     
...
% 4 Sec (0.25 Hz)
    ...
    title1 = 'NGA-W2 Median GMM Comparison - M7 - Vs30 = 1080 m/s';
    text(10,20,title1,'FontWeight','bold'); % Position of Title [x-axis, y-axis]
    saveas(gcf,'NGAW2_SA4P0_1080_GM_vs_Distance_Plot_M7','png')    
...
% 5 Sec (0.2 Hz)
    ...
    title1 = 'NGA-W2 Median GMM Comparison - M7 - Vs30 = 1080 m/s';
    text(10,20,title1,'FontWeight','bold'); % Position of Title [x-axis, y-axis]
    saveas(gcf,'NGAW2_SA5P0_1080_GM_vs_Distance_Plot_M7','png')  
...
% PGA
    ...
    set(h,'Interpreter','none');
    set(h,'Position',[40 10]); % Position of subtilte, [center value, y-axis]
    title1 = 'NGA-W2 Median GMM Comparison - M7.5 - Vs30 = 1080 m/s';
    text(10,20,title1,'FontWeight','bold'); % Position of Title [x-axis, y-axis]
    saveas(gcf,'NGAW2_PGA_1080_GM_vs_Distance_Plot_M7p5','png')
...
% 0.1 Sec (10 Hz)
    ...
    title1 = 'NGA-W2 Median GMM Comparison - M7.5 - Vs30 = 1080 m/s';
    text(10,20,title1,'FontWeight','bold'); % Position of Title [x-axis, y-axis]
    saveas(gcf,'NGAW2_SA0P1_1080_GM_vs_Distance_Plot_M7p5','png')    
...
% 0.2 Sec (5 Hz)
    ...
    title1 = 'NGA-W2 Median GMM Comparison - M7.5 - Vs30 = 1080 m/s';
    text(10,20,title1,'FontWeight','bold'); % Position of Title [x-axis, y-axis]
    saveas(gcf,'NGAW2_SA0P2_1080_GM_vs_Distance_Plot_M7p5','png')      
...
% 0.3 Sec (3.33 Hz)
    ...
    title1 = 'NGA-W2 Median GMM Comparison - M7.5 - Vs30 = 1080 m/s';
    text(10,20,title1,'FontWeight','bold'); % Position of Title [x-axis, y-axis]
    saveas(gcf,'NGAW2_SA0P3_1080_GM_vs_Distance_Plot_M7p5','png')          
...
% 0.5 Sec (2 Hz)
    ...
    title1 = 'NGA-W2 Median GMM Comparison - M7.5 - Vs30 = 1080 m/s';
    text(10,20,title1,'FontWeight','bold'); % Position of Title [x-axis, y-axis]
    saveas(gcf,'NGAW2_SA0P5_1080_GM_vs_Distance_Plot_M7p5','png')     
...
% 0.75 Sec (1.33 Hz)
    ...
    title1 = 'NGA-W2 Median GMM Comparison - M7.5 - Vs30 = 1080 m/s';
    text(10,20,title1,'FontWeight','bold'); % Position of Title [x-axis, y-axis]
    saveas(gcf,'NGAW2_SA0P75_1080_GM_vs_Distance_Plot_M7p5','png')       
...
% 1 Sec (1 Hz)
    ...
    text(10,20,title1,'FontWeight','bold'); % Position of Title [x-axis, y-axis]
    saveas(gcf,'NGAW2_SA1P0_1080_GM_vs_Distance_Plot_M7p5','png')      
...
% 2 Sec (0.5 Hz)
    ...
    title1 = 'NGA-W2 Median GMM Comparison - M7.5 - Vs30 = 1080 m/s';
    text(10,20,title1,'FontWeight','bold'); % Position of Title [x-axis, y-axis]
    saveas(gcf,'NGAW2_SA2P0_1080_GM_vs_Distance_Plot_M7p5','png')     
...
% 3 Sec (0.33 Hz)
    ...
    title1 = 'NGA-W2 Median GMM Comparison - M7.5 - Vs30 = 1080 m/s';
    text(10,20,title1,'FontWeight','bold'); % Position of Title [x-axis, y-axis]
    saveas(gcf,'NGAW2_SA3P0_1080_GM_vs_Distance_Plot_M7p5','png')     
...
% 4 Sec (0.25 Hz)
    ...
    title1 = 'NGA-W2 Median GMM Comparison - M7.5 - Vs30 = 1080 m/s';
    text(10,20,title1,'FontWeight','bold'); % Position of Title [x-axis, y-axis]
    saveas(gcf,'NGAW2_SA4P0_1080_GM_vs_Distance_Plot_M7p5','png')    
...
% 5 Sec (0.2 Hz)
    ...
    title1 = 'NGA-W2 Median GMM Comparison - M7.5 - Vs30 = 1080 m/s';
    text(10,20,title1,'FontWeight','bold'); % Position of Title [x-axis, y-axis]
    saveas(gcf,'NGAW2_SA5P0_1080_GM_vs_Distance_Plot_M7p5','png') 
...
% PGA
    ...
    set(h,'Interpreter','none');
    set(h,'Position',[40 10]); % Position of subtilte, [center value, y-axis]
    title1 = 'NGA-W2 Median GMM Comparison - M8 - Vs30 = 1080 m/s';
    text(10,20,title1,'FontWeight','bold'); % Position of Title [x-axis, y-axis]
    saveas(gcf,'NGAW2_PGA_1080_GM_vs_Distance_Plot_M8','png')
...
% 0.1 Sec (10 Hz)
    ...
    title1 = 'NGA-W2 Median GMM Comparison - M8 - Vs30 = 1080 m/s';
    text(10,20,title1,'FontWeight','bold'); % Position of Title [x-axis, y-axis]
    saveas(gcf,'NGAW2_SA0P1_1080_GM_vs_Distance_Plot_M8','png')    
...
% 0.2 Sec (5 Hz)
    ...
    title1 = 'NGA-W2 Median GMM Comparison - M8 - Vs30 = 1080 m/s';
    text(10,20,title1,'FontWeight','bold'); % Position of Title [x-axis, y-axis]
    saveas(gcf,'NGAW2_SA0P2_1080_GM_vs_Distance_Plot_M8','png')      
...
% 0.3 Sec (3.33 Hz)
    ...
    title1 = 'NGA-W2 Median GMM Comparison - M8 - Vs30 = 1080 m/s';
    text(10,20,title1,'FontWeight','bold'); % Position of Title [x-axis, y-axis]
    saveas(gcf,'NGAW2_SA0P3_1080_GM_vs_Distance_Plot_M8','png')          
...
% 0.5 Sec (2 Hz)
    ...
    title1 = 'NGA-W2 Median GMM Comparison - M8 - Vs30 = 1080 m/s';
    text(10,20,title1,'FontWeight','bold'); % Position of Title [x-axis, y-axis]
    saveas(gcf,'NGAW2_SA0P5_1080_GM_vs_Distance_Plot_M8','png')     
...
% 0.75 Sec (1.33 Hz)
    ...
    title1 = 'NGA-W2 Median GMM Comparison - M8 - Vs30 = 1080 m/s';
    text(10,20,title1,'FontWeight','bold'); % Position of Title [x-axis, y-axis]
    saveas(gcf,'NGAW2_SA0P75_1080_GM_vs_Distance_Plot_M8','png')       
...
% 1 Sec (1 Hz)
    ...
    title1 = 'NGA-W2 Median GMM Comparison - M8 - Vs30 = 1080 m/s';
    text(10,20,title1,'FontWeight','bold'); % Position of Title [x-axis, y-axis]
    saveas(gcf,'NGAW2_SA1P0_1080_GM_vs_Distance_Plot_M8','png')      
...
% 2 Sec (0.5 Hz)
    ...
    title1 = 'NGA-W2 Median GMM Comparison - M8 - Vs30 = 1080 m/s';
    text(10,20,title1,'FontWeight','bold'); % Position of Title [x-axis, y-axis]
    saveas(gcf,'NGAW2_SA2P0_1080_GM_vs_Distance_Plot_M8','png')     
...
% 3 Sec (0.33 Hz)
    ...
    title1 = 'NGA-W2 Median GMM Comparison - M8 - Vs30 = 1080 m/s';
    text(10,20,title1,'FontWeight','bold'); % Position of Title [x-axis, y-axis]
    saveas(gcf,'NGAW2_SA3P0_1080_GM_vs_Distance_Plot_M8','png')     
...
% 4 Sec (0.25 Hz)
    ...
    title1 = 'NGA-W2 Median GMM Comparison - M8 - Vs30 = 1080 m/s';
    text(10,20,title1,'FontWeight','bold'); % Position of Title [x-axis, y-axis]
    saveas(gcf,'NGAW2_SA4P0_1080_GM_vs_Distance_Plot_M8','png')    
    
% 5 Sec (0.2 Hz)

    figure('visible','off')
    % GM vs. Distance Plots
    loglog(R, nshmp_haz_data_ASK_14(1:19,56), 'b-','LineWidth',2);
    hold on
    grid on 
    loglog(R, nshmp_haz_data_BSSA_14(1:19,56), 'r-','LineWidth',2);
    loglog(R, nshmp_haz_data_CB_14(1:19,56), 'g-','LineWidth',2);
    loglog(R, nshmp_haz_data_CY_14(1:19,56), 'c-','LineWidth',2);
    loglog(R, nshmp_haz_data_IDRISS_14(1:19,56), 'k-','LineWidth',2);
    ylabel('Median 5 Second Spectral Acceleration (g)')
    ylim([10^-4 10])
    xlim([5 300])
    xlabel('Source Distance (km)');
    ...
    title1 = 'NGA-W2 Median GMM Comparison - M8 - Vs30 = 1080 m/s';
    text(10,20,title1,'FontWeight','bold'); % Position of Title [x-axis, y-axis]
    saveas(gcf,'NGAW2_SA5P0_1080_GM_vs_Distance_Plot_M8','png') 