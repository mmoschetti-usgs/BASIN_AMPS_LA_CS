%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%
% Name: Plot_GMM_v_Distance_Comparisons_C_530.m
%
...
%% Import Data from Excel Spreadsheets
    ...
    nshmp_haz_data_ASK_14 = csvread('ASK_14_Median_GMMs_SS_530.csv');
    R = nshmp_haz_data_ASK_14(1:19,1);
    nshmp_haz_data_BSSA_14 = csvread('BSSA_14_Median_GMMs_SS_530.csv');
    nshmp_haz_data_CB_14 = csvread('CB_14_Median_GMMs_SS_530.csv');
    nshmp_haz_data_CY_14 = csvread('CY_14_Median_GMMs_SS_530.csv');
    nshmp_haz_data_IDRISS_14 = csvread('IDRISS_14_Median_GMMs_SS_530.csv');
...
% PGA
    ...
    title1 = 'NGA-W2 Median GMM Comparison - M5 - Vs30 = 530 m/s';
    text(12,20,title1,'FontWeight','bold'); % Position of Title [x-axis, y-axis]
    saveas(gcf,'NGAW2_PGA_530_GM_vs_Distance_Plot_M5','png')
...
% 0.1 Sec (10 Hz)
    ...
    title1 = 'NGA-W2 Median GMM Comparison - M5 - Vs30 = 530 m/s';
    text(12,20,title1,'FontWeight','bold'); % Position of Title [x-axis, y-axis]
    saveas(gcf,'NGAW2_SA0P1_530_GM_vs_Distance_Plot_M5','png')    
...
% 0.2 Sec (5 Hz)
    ...
    title1 = 'NGA-W2 Median GMM Comparison - M5 - Vs30 = 530 m/s';
    text(12,20,title1,'FontWeight','bold'); % Position of Title [x-axis, y-axis]
    saveas(gcf,'NGAW2_SA0P2_530_GM_vs_Distance_Plot_M5','png')      
...
% 0.3 Sec (3.33 Hz)
    ...
    title1 = 'NGA-W2 Median GMM Comparison - M5 - Vs30 = 530 m/s';
    text(12,20,title1,'FontWeight','bold'); % Position of Title [x-axis, y-axis]
    saveas(gcf,'NGAW2_SA0P3_530_GM_vs_Distance_Plot_M5','png')          
...
% 0.5 Sec (2 Hz)
    ...
    title1 = 'NGA-W2 Median GMM Comparison - M5 - Vs30 = 530 m/s';
    text(12,20,title1,'FontWeight','bold'); % Position of Title [x-axis, y-axis]
    saveas(gcf,'NGAW2_SA0P5_530_GM_vs_Distance_Plot_M5','png')     
...
% 0.75 Sec (1.33 Hz)
    ...
    title1 = 'NGA-W2 Median GMM Comparison - M5 - Vs30 = 530 m/s';
    text(12,20,title1,'FontWeight','bold'); % Position of Title [x-axis, y-axis]
    saveas(gcf,'NGAW2_SA0P75_530_GM_vs_Distance_Plot_M5','png')       
...
% 1 Sec (1 Hz)
    ...
    title1 = 'NGA-W2 Median GMM Comparison - M5 - Vs30 = 530 m/s';
    text(12,20,title1,'FontWeight','bold'); % Position of Title [x-axis, y-axis]
    saveas(gcf,'NGAW2_SA1P0_530_GM_vs_Distance_Plot_M5','png')      
...
% 2 Sec (0.5 Hz)
    ...
    title1 = 'NGA-W2 Median GMM Comparison - M5 - Vs30 = 530 m/s';
    text(12,20,title1,'FontWeight','bold'); % Position of Title [x-axis, y-axis]
    saveas(gcf,'NGAW2_SA2P0_530_GM_vs_Distance_Plot_M5','png')     
...
% 3 Sec (0.33 Hz)
    ...
    title1 = 'NGA-W2 Median GMM Comparison - M5 - Vs30 = 530 m/s';
    text(12,20,title1,'FontWeight','bold'); % Position of Title [x-axis, y-axis]
    saveas(gcf,'NGAW2_SA3P0_530_GM_vs_Distance_Plot_M5','png')     
...
% 4 Sec (0.25 Hz)
    ...
    title1 = 'NGA-W2 Median GMM Comparison - M5 - Vs30 = 530 m/s';
    text(12,20,title1,'FontWeight','bold'); % Position of Title [x-axis, y-axis]
    saveas(gcf,'NGAW2_SA4P0_530_GM_vs_Distance_Plot_M5','png')    
...
% 5 Sec (0.2 Hz)
    ...
    title1 = 'NGA-W2 Median GMM Comparison - M5 - Vs30 = 530 m/s';
    text(12,20,title1,'FontWeight','bold'); % Position of Title [x-axis, y-axis]
    saveas(gcf,'NGAW2_SA5P0_530_GM_vs_Distance_Plot_M5','png')   
...
% PGA
    ...
    set(h,'Interpreter','none');
    set(h,'Position',[40 10]); % Position of subtilte, [center value, y-axis]
    title1 = 'NGA-W2 Median GMM Comparison - M6 - Vs30 = 530 m/s';
    text(12,20,title1,'FontWeight','bold'); % Position of Title [x-axis, y-axis]
    saveas(gcf,'NGAW2_PGA_530_GM_vs_Distance_Plot_M6','png')
...
% 0.1 Sec (10 Hz)
    ...
    title1 = 'NGA-W2 Median GMM Comparison - M6 - Vs30 = 530 m/s';
    text(12,20,title1,'FontWeight','bold'); % Position of Title [x-axis, y-axis]
    saveas(gcf,'NGAW2_SA0P1_530_GM_vs_Distance_Plot_M6','png')    
...
% 0.2 Sec (5 Hz)
    ...
    title1 = 'NGA-W2 Median GMM Comparison - M6 - Vs30 = 530 m/s';
    text(12,20,title1,'FontWeight','bold'); % Position of Title [x-axis, y-axis]
    saveas(gcf,'NGAW2_SA0P2_530_GM_vs_Distance_Plot_M6','png')      
...
% 0.3 Sec (3.33 Hz)
    ...
    title1 = 'NGA-W2 Median GMM Comparison - M6 - Vs30 = 530 m/s';
    text(12,20,title1,'FontWeight','bold'); % Position of Title [x-axis, y-axis]
    saveas(gcf,'NGAW2_SA0P3_530_GM_vs_Distance_Plot_M6','png')          
...
% 0.5 Sec (2 Hz)
    ...
    title1 = 'NGA-W2 Median GMM Comparison - M6 - Vs30 = 530 m/s';
    text(12,20,title1,'FontWeight','bold'); % Position of Title [x-axis, y-axis]
    saveas(gcf,'NGAW2_SA0P5_530_GM_vs_Distance_Plot_M6','png')     
...
% 0.75 Sec (1.33 Hz)
    ...
    title1 = 'NGA-W2 Median GMM Comparison - M6 - Vs30 = 530 m/s';
    text(12,20,title1,'FontWeight','bold'); % Position of Title [x-axis, y-axis]
    saveas(gcf,'NGAW2_SA0P75_530_GM_vs_Distance_Plot_M6','png')       
...
% 1 Sec (1 Hz)
    ...
    title1 = 'NGA-W2 Median GMM Comparison - M6 - Vs30 = 530 m/s';
    text(12,20,title1,'FontWeight','bold'); % Position of Title [x-axis, y-axis]
    saveas(gcf,'NGAW2_SA1P0_530_GM_vs_Distance_Plot_M6','png')      
...
% 2 Sec (0.5 Hz)
    ...
    title1 = 'NGA-W2 Median GMM Comparison - M6 - Vs30 = 530 m/s';
    text(12,20,title1,'FontWeight','bold'); % Position of Title [x-axis, y-axis]
    saveas(gcf,'NGAW2_SA2P0_530_GM_vs_Distance_Plot_M6','png')     
...
% 3 Sec (0.33 Hz)
    ...
    title1 = 'NGA-W2 Median GMM Comparison - M6 - Vs30 = 530 m/s';
    text(12,20,title1,'FontWeight','bold'); % Position of Title [x-axis, y-axis]
    saveas(gcf,'NGAW2_SA3P0_530_GM_vs_Distance_Plot_M6','png')     
...
% 4 Sec (0.25 Hz)
    ...
    title1 = 'NGA-W2 Median GMM Comparison - M6 - Vs30 = 530 m/s';
    text(12,20,title1,'FontWeight','bold'); % Position of Title [x-axis, y-axis]
    saveas(gcf,'NGAW2_SA4P0_530_GM_vs_Distance_Plot_M6','png')    
...
% 5 Sec (0.2 Hz)
    ...
    title1 = 'NGA-W2 Median GMM Comparison - M6 - Vs30 = 530 m/s';
    text(12,20,title1,'FontWeight','bold'); % Position of Title [x-axis, y-axis]
    saveas(gcf,'NGAW2_SA5P0_530_GM_vs_Distance_Plot_M6','png') 
...
% PGA
    ...
    set(h,'Interpreter','none');
    set(h,'Position',[40 10]); % Position of subtilte, [center value, y-axis]
    title1 = 'NGA-W2 Median GMM Comparison - M7 - Vs30 = 530 m/s';
    text(12,20,title1,'FontWeight','bold'); % Position of Title [x-axis, y-axis]
    saveas(gcf,'NGAW2_PGA_530_GM_vs_Distance_Plot_M7','png')
...
% 0.1 Sec (10 Hz)
    ...
    title1 = 'NGA-W2 Median GMM Comparison - M7 - Vs30 = 530 m/s';
    text(12,20,title1,'FontWeight','bold'); % Position of Title [x-axis, y-axis]
    saveas(gcf,'NGAW2_SA0P1_530_GM_vs_Distance_Plot_M7','png')    
...
% 0.2 Sec (5 Hz)
    ...
    title1 = 'NGA-W2 Median GMM Comparison - M7 - Vs30 = 530 m/s';
    text(12,20,title1,'FontWeight','bold'); % Position of Title [x-axis, y-axis]
    saveas(gcf,'NGAW2_SA0P2_530_GM_vs_Distance_Plot_M7','png')      
...
% 0.3 Sec (3.33 Hz)
    ...
    title1 = 'NGA-W2 Median GMM Comparison - M7 - Vs30 = 530 m/s';
    text(12,20,title1,'FontWeight','bold'); % Position of Title [x-axis, y-axis]
    saveas(gcf,'NGAW2_SA0P3_530_GM_vs_Distance_Plot_M7','png')          
...
% 0.5 Sec (2 Hz)
    ...
    title1 = 'NGA-W2 Median GMM Comparison - M7 - Vs30 = 530 m/s';
    text(12,20,title1,'FontWeight','bold'); % Position of Title [x-axis, y-axis]
    saveas(gcf,'NGAW2_SA0P5_530_GM_vs_Distance_Plot_M7','png')     
...
% 0.75 Sec (1.33 Hz)
    ...
    title1 = 'NGA-W2 Median GMM Comparison - M7 - Vs30 = 530 m/s';
    text(12,20,title1,'FontWeight','bold'); % Position of Title [x-axis, y-axis]
    saveas(gcf,'NGAW2_SA0P75_530_GM_vs_Distance_Plot_M7','png')       
...
% 1 Sec (1 Hz)
    ...
    title1 = 'NGA-W2 Median GMM Comparison - M7 - Vs30 = 530 m/s';
    text(12,20,title1,'FontWeight','bold'); % Position of Title [x-axis, y-axis]
    saveas(gcf,'NGAW2_SA1P0_530_GM_vs_Distance_Plot_M7','png')      
...
% 2 Sec (0.5 Hz)
    ...
    title1 = 'NGA-W2 Median GMM Comparison - M7 - Vs30 = 530 m/s';
    text(12,20,title1,'FontWeight','bold'); % Position of Title [x-axis, y-axis]
    saveas(gcf,'NGAW2_SA2P0_530_GM_vs_Distance_Plot_M7','png')     
...
% 3 Sec (0.33 Hz)
    ...
    title1 = 'NGA-W2 Median GMM Comparison - M7 - Vs30 = 530 m/s';
    text(12,20,title1,'FontWeight','bold'); % Position of Title [x-axis, y-axis]
    saveas(gcf,'NGAW2_SA3P0_530_GM_vs_Distance_Plot_M7','png')     
...
% 4 Sec (0.25 Hz)
    ...
    title1 = 'NGA-W2 Median GMM Comparison - M7 - Vs30 = 530 m/s';
    text(12,20,title1,'FontWeight','bold'); % Position of Title [x-axis, y-axis]
    saveas(gcf,'NGAW2_SA4P0_530_GM_vs_Distance_Plot_M7','png')    
...
% 5 Sec (0.2 Hz)
    ...
    title1 = 'NGA-W2 Median GMM Comparison - M7 - Vs30 = 530 m/s';
    text(12,20,title1,'FontWeight','bold'); % Position of Title [x-axis, y-axis]
    saveas(gcf,'NGAW2_SA5P0_530_GM_vs_Distance_Plot_M7','png')  
...
% PGA
    ...
    set(h,'Interpreter','none');
    set(h,'Position',[40 10]); % Position of subtilte, [center value, y-axis]
    title1 = 'NGA-W2 Median GMM Comparison - M7.5 - Vs30 = 530 m/s';
    text(12,20,title1,'FontWeight','bold'); % Position of Title [x-axis, y-axis]
    saveas(gcf,'NGAW2_PGA_530_GM_vs_Distance_Plot_M7p5','png')
...
% 0.1 Sec (10 Hz)
    ...
    title1 = 'NGA-W2 Median GMM Comparison - M7.5 - Vs30 = 530 m/s';
    text(12,20,title1,'FontWeight','bold'); % Position of Title [x-axis, y-axis]
    saveas(gcf,'NGAW2_SA0P1_530_GM_vs_Distance_Plot_M7p5','png')    
...
% 0.2 Sec (5 Hz)
    ...
    title1 = 'NGA-W2 Median GMM Comparison - M7.5 - Vs30 = 530 m/s';
    text(12,20,title1,'FontWeight','bold'); % Position of Title [x-axis, y-axis]
    saveas(gcf,'NGAW2_SA0P2_530_GM_vs_Distance_Plot_M7p5','png')      
...
% 0.3 Sec (3.33 Hz)
    ...
    title1 = 'NGA-W2 Median GMM Comparison - M7.5 - Vs30 = 530 m/s';
    text(12,20,title1,'FontWeight','bold'); % Position of Title [x-axis, y-axis]
    saveas(gcf,'NGAW2_SA0P3_530_GM_vs_Distance_Plot_M7p5','png')          
...
% 0.5 Sec (2 Hz)
    ...
    title1 = 'NGA-W2 Median GMM Comparison - M7.5 - Vs30 = 530 m/s';
    text(12,20,title1,'FontWeight','bold'); % Position of Title [x-axis, y-axis]
    saveas(gcf,'NGAW2_SA0P5_530_GM_vs_Distance_Plot_M7p5','png')     
...
% 0.75 Sec (1.33 Hz)
    ...
    title1 = 'NGA-W2 Median GMM Comparison - M7.5 - Vs30 = 530 m/s';
    text(12,20,title1,'FontWeight','bold'); % Position of Title [x-axis, y-axis]
    saveas(gcf,'NGAW2_SA0P75_530_GM_vs_Distance_Plot_M7p5','png')       
...
% 1 Sec (1 Hz)
    ...
    text(12,20,title1,'FontWeight','bold'); % Position of Title [x-axis, y-axis]
    saveas(gcf,'NGAW2_SA1P0_530_GM_vs_Distance_Plot_M7p5','png')      
...
% 2 Sec (0.5 Hz)
    ...
    title1 = 'NGA-W2 Median GMM Comparison - M7.5 - Vs30 = 530 m/s';
    text(12,20,title1,'FontWeight','bold'); % Position of Title [x-axis, y-axis]
    saveas(gcf,'NGAW2_SA2P0_530_GM_vs_Distance_Plot_M7p5','png')     
...
% 3 Sec (0.33 Hz)
    ...
    title1 = 'NGA-W2 Median GMM Comparison - M7.5 - Vs30 = 530 m/s';
    text(12,20,title1,'FontWeight','bold'); % Position of Title [x-axis, y-axis]
    saveas(gcf,'NGAW2_SA3P0_530_GM_vs_Distance_Plot_M7p5','png')     
...
% 4 Sec (0.25 Hz)
    ...
    title1 = 'NGA-W2 Median GMM Comparison - M7.5 - Vs30 = 530 m/s';
    text(12,20,title1,'FontWeight','bold'); % Position of Title [x-axis, y-axis]
    saveas(gcf,'NGAW2_SA4P0_530_GM_vs_Distance_Plot_M7p5','png')    
...
% 5 Sec (0.2 Hz)
    ...
    title1 = 'NGA-W2 Median GMM Comparison - M7.5 - Vs30 = 530 m/s';
    text(12,20,title1,'FontWeight','bold'); % Position of Title [x-axis, y-axis]
    saveas(gcf,'NGAW2_SA5P0_530_GM_vs_Distance_Plot_M7p5','png') 
...
% PGA
    ...
    set(h,'Interpreter','none');
    set(h,'Position',[40 10]); % Position of subtilte, [center value, y-axis]
    title1 = 'NGA-W2 Median GMM Comparison - M8 - Vs30 = 530 m/s';
    text(12,20,title1,'FontWeight','bold'); % Position of Title [x-axis, y-axis]
    saveas(gcf,'NGAW2_PGA_530_GM_vs_Distance_Plot_M8','png')
...
% 0.1 Sec (10 Hz)
    ...
    title1 = 'NGA-W2 Median GMM Comparison - M8 - Vs30 = 530 m/s';
    text(12,20,title1,'FontWeight','bold'); % Position of Title [x-axis, y-axis]
    saveas(gcf,'NGAW2_SA0P1_530_GM_vs_Distance_Plot_M8','png')    
...
% 0.2 Sec (5 Hz)
    ...
    title1 = 'NGA-W2 Median GMM Comparison - M8 - Vs30 = 530 m/s';
    text(12,20,title1,'FontWeight','bold'); % Position of Title [x-axis, y-axis]
    saveas(gcf,'NGAW2_SA0P2_530_GM_vs_Distance_Plot_M8','png')      
...
% 0.3 Sec (3.33 Hz)
    ...
    title1 = 'NGA-W2 Median GMM Comparison - M8 - Vs30 = 530 m/s';
    text(12,20,title1,'FontWeight','bold'); % Position of Title [x-axis, y-axis]
    saveas(gcf,'NGAW2_SA0P3_530_GM_vs_Distance_Plot_M8','png')          
...
% 0.5 Sec (2 Hz)
    ...
    title1 = 'NGA-W2 Median GMM Comparison - M8 - Vs30 = 530 m/s';
    text(12,20,title1,'FontWeight','bold'); % Position of Title [x-axis, y-axis]
    saveas(gcf,'NGAW2_SA0P5_530_GM_vs_Distance_Plot_M8','png')     
...
% 0.75 Sec (1.33 Hz)
    ...
    title1 = 'NGA-W2 Median GMM Comparison - M8 - Vs30 = 530 m/s';
    text(12,20,title1,'FontWeight','bold'); % Position of Title [x-axis, y-axis]
    saveas(gcf,'NGAW2_SA0P75_530_GM_vs_Distance_Plot_M8','png')       
...
% 1 Sec (1 Hz)
    ...
    title1 = 'NGA-W2 Median GMM Comparison - M8 - Vs30 = 530 m/s';
    text(12,20,title1,'FontWeight','bold'); % Position of Title [x-axis, y-axis]
    saveas(gcf,'NGAW2_SA1P0_530_GM_vs_Distance_Plot_M8','png')      
...
% 2 Sec (0.5 Hz)
    ...
    title1 = 'NGA-W2 Median GMM Comparison - M8 - Vs30 = 530 m/s';
    text(12,20,title1,'FontWeight','bold'); % Position of Title [x-axis, y-axis]
    saveas(gcf,'NGAW2_SA2P0_530_GM_vs_Distance_Plot_M8','png')     
...
% 3 Sec (0.33 Hz)
    ...
    title1 = 'NGA-W2 Median GMM Comparison - M8 - Vs30 = 530 m/s';
    text(12,20,title1,'FontWeight','bold'); % Position of Title [x-axis, y-axis]
    saveas(gcf,'NGAW2_SA3P0_530_GM_vs_Distance_Plot_M8','png')     
...
% 4 Sec (0.25 Hz)
    ...
    title1 = 'NGA-W2 Median GMM Comparison - M8 - Vs30 = 530 m/s';
    text(12,20,title1,'FontWeight','bold'); % Position of Title [x-axis, y-axis]
    saveas(gcf,'NGAW2_SA4P0_530_GM_vs_Distance_Plot_M8','png')    
...
% 5 Sec (0.2 Hz)
    ...
    title1 = 'NGA-W2 Median GMM Comparison - M8 - Vs30 = 530 m/s';
    text(12,20,title1,'FontWeight','bold'); % Position of Title [x-axis, y-axis]
    saveas(gcf,'NGAW2_SA5P0_530_GM_vs_Distance_Plot_M8','png') 